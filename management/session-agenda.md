...
| ⚠ **Eine neue Entscheidung: `promt-team` gründen? Frist 20.08., Default „ja"** | Dein „starte promt-team" (`pm/N-0040`) ist angekommen — **der Kandidat steht schon als #14 im Pool**, samt deiner Rollenbeschreibung. Die **Gründung** dürfen wir nach unseren eigenen Regeln nicht selbst beschließen (Klasse A). Drei Dinge sagt deine Beschreibung nicht, und wir wollen sie nicht raten: **Profil**, **Datenklasse** (das Team liest Transkripte anderer Rollen — da kann alles drinstehen, was je durch eine Rolle lief) und **Wirkbereich** („alle KI-Rollen" schließt uns ein). **Schweigen heißt gründen** (TG-a): eng, Datenklasse `sensibel`, erster Auftrag **Messgrundlage**. ⚠ Denn deine eigene Beschreibung verlangt „ohne Baseline kein Optimierungslauf" — und die Baseline gibt es heute nicht. |
